...
function About (){
  ...
  const handleNavClick = (event, targetId) => {
    ...
    return(
      ...
      <Image/>
<div>
We meet in the <b>Atworth Village Hall</b> at <b>7:30pm</b> on the <b>first Monday of the months October to June inclusive</b>, except on Bank Holidays, when we meet on the second Monday of the month.
</div>
<br></br>
<div>
...
<br></br>
<div>
To sign up as a guest or full member, please contact Keith Ruffell at kgruffell@gmail.com, or simply turn up to one of our talks and pay at the hall. (confirm with David)</div>
<br></br>
<div>
